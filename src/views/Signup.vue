      ...
      <b-card title="Sign Up">
        <b-form @submit.prevent="signUpHandler" @keyup.enter="signUpHandler">
          <b-form-group id="input-group-1" label="First Name" label-for="firstname">
            <input v-model.lazy="userInput.firstName" type="text" name="firstName" />
          </b-form-group>
          ...
          <b-form-group id="input-group-4" label="Choose a Password" label-for="password">
            <input v-model.lazy="userInput.password" type="password" name="password" />
          </b-form-group>
          <b-form-group id="input-group-5" label="Verify Password" label-for="redopassword">
